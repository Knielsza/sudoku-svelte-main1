...
<style lang="scss">
  ...
  .cell {
    ...
    width: calc(100% / 9);
    height: 55px;
    border-top: 1px solid #c55ffc;
    border-left: 1px solid #c55ffc;
    font-size: 24px;
    user-select: none;
    ...
    &:nth-child(9n) {
      border-right: 2px solid #c55ffc;
    }
    &:nth-child(3n + 1) {
      border-left: 2px solid #c55ffc;
    }
    &:nth-child(n + 73) {
      border-bottom: 2px solid #c55ffc;
    }
    &:nth-child(-n + 9),
    &:nth-child(n + 28):nth-child(-n + 36),
    &:nth-child(n + 55):nth-child(-n + 63) {
      border-top: 2px solid #c55ffc;
    }
  }
</style>
